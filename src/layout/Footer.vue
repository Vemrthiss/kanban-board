<template>
    <div class="footer">
        <div class="footer__text">
            <p class="footer__text-content">Done by <a :href="githubLink" class="footer__link">Joel Tay</a></p>
        </div>
        ...
        <div class="footer__icon-group">
            <a class="footer__icon footer__icon-github" :href="projectLink">
...
<script>
    export default {
        data() {
            return {
                githubLink: "https://github.com/Vemrthiss",
                projectLink: "https://github.com/Vemrthiss/kanban-board",
